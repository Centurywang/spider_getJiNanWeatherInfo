...
jQuery.SelectBox = function(selectobj, options) {
	...
	function setupContainer(options) {
		...
		$container.hover(function(){hasfocus = 1;},function(){if(hasfocus == 1) hideMe();});
		return $container;
	}
	
	function setupInput(options) {
		$("input#"+elm_id+"_input").remove();
...
//document.writeln("<script type=\"text/javascript\" src=\"http://www.tianqi.com/img/rl_xz.js\"></script>");
